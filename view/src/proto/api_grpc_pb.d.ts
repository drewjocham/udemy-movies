...
interface IApiServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    testPost: IApiServiceService_ITestPost;
}
...
interface IApiServiceService_ITestPost extends grpc.MethodDefinition<api_pb.TestRequest, api_pb.TestResponse> {
    path: "/ApiService/TestPost";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<api_pb.TestRequest>;
    requestDeserialize: grpc.deserialize<api_pb.TestRequest>;
...
export interface IApiServiceServer extends grpc.UntypedServiceImplementation {
    ...
    testPost: grpc.handleUnaryCall<api_pb.TestRequest, api_pb.TestResponse>;
}
...
export interface IApiServiceClient {
    ...
    testPost(request: api_pb.TestRequest, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
    testPost(request: api_pb.TestRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
    testPost(request: api_pb.TestRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
}
...
export class ApiServiceClient extends grpc.Client implements IApiServiceClient {
    ...
    public testPost(request: api_pb.TestRequest, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
    public testPost(request: api_pb.TestRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
    public testPost(request: api_pb.TestRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: api_pb.TestResponse) => void): grpc.ClientUnaryCall;
}
