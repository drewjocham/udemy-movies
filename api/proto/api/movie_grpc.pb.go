...
type MovieServiceClient interface {
	GetAllMovies(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*GetAllMoviesResponse, error)
	CreateMovie(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*CreateMovieResponse, error)
...
func (c *movieServiceClient) GetAllMovies(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*GetAllMoviesResponse, error) {
	out := new(GetAllMoviesResponse)
	err := c.cc.Invoke(ctx, "/MovieService/GetAllMovies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) CreateMovie(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*CreateMovieResponse, error) {
...
func (c *movieServiceClient) DeleteMovie(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*MovieResponse, error) {
	out := new(MovieResponse)
...
type MovieServiceServer interface {
	GetAllMovies(context.Context, *MovieRequest) (*GetAllMoviesResponse, error)
	CreateMovie(context.Context, *MovieRequest) (*CreateMovieResponse, error)
...
func (UnimplementedMovieServiceServer) GetAllMovies(context.Context, *MovieRequest) (*GetAllMoviesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllMovies not implemented")
}
func (UnimplementedMovieServiceServer) CreateMovie(context.Context, *MovieRequest) (*CreateMovieResponse, error) {
...
func (UnimplementedMovieServiceServer) DeleteMovie(context.Context, *MovieRequest) (*MovieResponse, error) {
...
func _MovieService_GetAllMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MovieService/GetAllMovies",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).GetAllMovies(ctx, req.(*MovieRequest))
	}
...
func _MovieService_DeleteMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).DeleteMovie(ctx, req.(*MovieRequest))
	}
	return interceptor(ctx, in, info, handler)
}
